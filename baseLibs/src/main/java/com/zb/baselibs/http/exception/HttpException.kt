package com.zb.baselibs.http.exception
...
open class BaseHttpException(
    ...
    val isNoLogin: Boolean
        get() = errorCode == 2

    val isError: Boolean
        get() = errorCode == 0

    val isNotAuthentication: Boolean
        get() = errorCode == 0 && errorMessage == "信息不存在"

    val isNotBindPhone: Boolean
        get() = errorCode == 301
}
...
class ServerCodeBadException(errorCode: Int, errorMessage: String) :
    ...
    constructor(bean: IHttpWrapBean<*>) : this(bean.code, bean.msg)
